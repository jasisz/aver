...
fn emit_cloudflare_pack(out_path: &Path, wasm_name: &str, wasm_file: &Path) {
    ...
    let worker_js = format!(
        r#"// Generated by `aver compile --pack cloudflare` — bootstrap that
...
import userWasm from "./{wasm_name}.wasm";
...
"#,
    ...
    let wrangler_toml = format!(
        r#"# Generated by `aver compile --pack cloudflare`. Edit as needed.
name = "{name}"
main = "worker.js"
