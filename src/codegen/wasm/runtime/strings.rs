...
// $char_from_code lives in `runtime/wat/char_from_code.part.wat`.
// $str_char_at lives in `runtime/wat/str_char_at.part.wat`.
// $byte_to_hex / $byte_from_hex live in `runtime/wat/byte_hex.part.wat`.
// $str_trim lives in `runtime/wat/str_trim.part.wat`.
// $str_to_lower / $str_to_upper live in `runtime/wat/str_case.part.wat`.
// $str_slice / $str_chars / $str_split / $str_join / $str_replace
// live in `runtime/wat/str_ops.part.wat`.
