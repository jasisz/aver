...
pub(in crate::codegen::wasm_gc) struct SlotTable {
    ...
    run_turn_scratch: RefCell<Option<(u32, u32)>>,
...
impl SlotTable {
    ...
    pub(in crate::codegen::wasm_gc) fn run_turn_scratch(&self) -> (u32, u32) {
        ...
        *self.run_turn_scratch.borrow_mut() = Some((waited, worked));
        (waited, worked)
    }
