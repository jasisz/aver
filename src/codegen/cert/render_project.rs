...
fn render_artifact(
    ...
    let fragment_proof = format!(
        concat!(
            "  dsimp [data, symFragmentClaims, stringEqClaims, stringConcatClaims, constructClaims, recursionClaims, mutualRecursionClaims, AverCert.AcceptedArtifact.accepted,\n",
