...
Lean currently checks the full K5 guided proof closure. Dafny has a separate
[linear Int/Bool guidance pilot](../../docs/dafny-guidance-spike.md); the rounding
arguments here remain outside its supported fragment.
