...
pub use aver_memory::{
    AllocSpace, ArenaList, ArenaTypes, ArenaUsage, FnValueName, MapLike, NanString, NanValue,
    PersistentMap,
    // Bit-layout constants needed by convert.rs and downstream code
    ARENA_REF_BIT, IMM_FALSE, IMM_TRUE, IMM_UNIT, INT_INLINE_MAX, INT_INLINE_MIN,
    SYMBOL_BUILTIN, SYMBOL_FN, SYMBOL_NAMESPACE, SYMBOL_NULLARY_VARIANT,
    TAG_ERR, TAG_IMMEDIATE, TAG_INLINE_VARIANT, TAG_INT, TAG_LIST, TAG_MAP, TAG_NONE,
    TAG_OK, TAG_RECORD, TAG_SOME, TAG_STRING, TAG_SYMBOL, TAG_TUPLE, TAG_VARIANT, TAG_VECTOR,
    WRAP_ERR, WRAP_OK, WRAP_SOME,
};
