...
const RUN_SCHEMA = {
  type: 'object', additionalProperties: false,
  required: ['checkPassed', 'universal', 'sorries', 'allHelpersVerified', 'note'],
  properties: {
