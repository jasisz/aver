...
const RUN_SCHEMA = {
  ...
  properties: {
    ...
    note: { type: 'string', description: 'ONE line, AVER-LEVEL ONLY (e.g. "all helpers proven, target open" or a parse/type error). NEVER quote Lean, tactics, the proof residual, or Lean axiom names.' },
  },
}
