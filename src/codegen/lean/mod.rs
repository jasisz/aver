...
"#,
    ...
    fn map_example_has_no_sorry_in_proof_mode() {
        ...
        assert!(lean.contains("theorem countWords_law_presenceMatchesContains :"));
        assert!(lean.contains("theorem countWords_law_trackedWordCount :"));
        assert!(lean.contains("AverMap.has_set_other"));
        assert!(lean.contains("AverMap.get_set_other"));
    }
    ...
    fn rle_example_omits_unproven_universal_laws_in_proof_mode() {
        ...
        assert!(!lean.contains(
            "theorem encode_law_roundtrip : ∀ (xs : List String), decode (encode xs) = xs := by"
        ));
        assert!(lean.contains(
