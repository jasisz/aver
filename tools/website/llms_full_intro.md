...
> Start with [`llms.txt`](https://averlang.dev/llms.txt). This file goes deeper. It documents the full toolchain and points to the language docs, examples and implementation notes.
...
- [Common Pushback](https://github.com/jasisz/aver/blob/main/docs/pushback.md): questions, objections and answers
...
- [Quicksort](https://github.com/jasisz/aver/blob/main/examples/data/quicksort.av): recursion and verify on a recursive algorithm
