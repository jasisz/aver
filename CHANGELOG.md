...
- VM now keeps `""` as an immediate `NanValue` too, with shared string access paths treating arena-backed and inline empty strings uniformly across interpreter, VM, and namespace builtins.
