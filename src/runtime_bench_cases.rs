...
pub const CORE_BENCH_CASES: &[CoreBenchCase] = &[
    ...
    CoreBenchCase {
        slug: "factorial_20",
        name: "factorial(20) x 5K",
        source: FACTORIAL_TCO,
    },
    CoreBenchCase {
        slug: "nested_match_1k",
        name: "nested_match(36K)",
        source: NESTED_MATCH,
    },
    CoreBenchCase {
        slug: "result_chain_10k",
        name: "result_chain(40K)",
        source: RESULT_CHAIN,
    },
    CoreBenchCase {
        slug: "list_walk_10",
        name: "list_walk(10K x5)",
        source: LIST_WALK,
    },
    CoreBenchCase {
        slug: "shapes_10k",
    ...
    CoreBenchCase {
        ...
        name: "record_heavy(40K)",
        source: RECORD_HEAVY,
    },
    CoreBenchCase {
        slug: "string_build_1k",
        name: "string_build(8K)",
        source: STRING_BUILD,
    },
    CoreBenchCase {
        slug: "error_pipeline_10k",
        name: "error_pipeline(20K)",
        source: ERROR_PIPELINE,
    },
    CoreBenchCase {
        slug: "list_builtins_1k",
        name: "list_builtins(40K)",
